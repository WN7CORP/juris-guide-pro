...
export const EnhancedCommentSystem = ({ 
  ...
  const contentComponent = (
    <>
      <div className="border-b border-gray-700 pb-4 flex-shrink-0">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-2 overflow-x-auto pb-2">
            <Select value={filterTag} onValueChange={setFilterTag}>
              <SelectTrigger className="w-32 bg-gray-800 border-gray-600 text-white shrink-0">
            ...
            <Select value={sortBy} onValueChange={(value) => setSortBy(value as SortOption)}>
              <SelectTrigger className="w-36 bg-gray-800 border-gray-600 text-white shrink-0">
                <SelectValue />
              </SelectTrigger>
              <SelectContent className="bg-gray-800 border-gray-600">
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <Button 
                  ...
                  className="bg-law-accent hover:bg-law-accent/90 shrink-0"
                >
                  {submitting ? (
  ...
  if (isMobile) {
    return (
      <Sheet open={open} onOpenChange={onOpenChange}>
        ...
        <SheetContent side="right" className="w-full bg-gray-900 border-gray-700 flex flex-col p-0">
