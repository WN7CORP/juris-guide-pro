        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="outline"
              size="sm"
              className="h-10 w-10 p-0 rounded-full bg-law-accent/20 border-law-accent/50 hover:bg-law-accent/30"
              onClick={togglePlay}
            >
              {isPlaying ? (
                <Pause className="h-4 w-4 text-law-accent" />
              ) : (
                <Play className="h-4 w-4 text-law-accent ml-0.5" />
              )}
            </Button>
