                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {codes.map((code) => (
                      ...
                      >
                        <Link 
                          to={`/codigos/${code.id}`} 
                          className="p-6 bg-netflix-dark border border-gray-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 block h-full flex flex-col"
                          onClick={() => {
                            ...
                            try {
                              ...
                              const updatedRecents = [
                                code.id,
                                ...recentCodes.filter((id: string) => id !== code.id)
                              ].slice(0, 5);
